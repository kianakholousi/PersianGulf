...
int Ba, DShift, BA, BC, Bx, By, DistanceB, GYx, GYy, DistanceGY, GBx, GBy, DistanceGB, Gy, Gy360 , arz , tool;
...
void loop() {
  ...
  {
//    delay(5500);
    if ((DistanceB < 95 && dis_back < 900) /*|| (Ba < 270 && Ba > 90)*/ ) fallout();
    if (dis_back < 400)
    {
      mot_ang(0);
    }
    else if (dis_back > 900 /*|| !(Ball)*/)
    {
      mot_ang(180);
    }
  }
